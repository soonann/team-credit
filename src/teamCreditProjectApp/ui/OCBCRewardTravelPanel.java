...
public class OCBCRewardTravelPanel extends MasterPanel {
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public OCBCRewardTravelPanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		...
		lblItemName.setText(alist.get(7).getItemName());
		...
		lblItemPoints.setText(blist.get(7).getItemPoints());
		...
		lblItemType.setText(clist.get(7).getItemType());
		...
		textItemDescription.setText(dlist.get(7).getItemDescription());
		...
		panel.add(btnRedeemcart);
				...
				btnNewButton.setIcon(new ImageIcon(OCBCRewardTravelPanel.class.getResource("/Redeem/img/Search.png")));
				...
				button.setIcon(new ImageIcon(OCBCRewardTravelPanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(OCBCRewardTravelPanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_1.setIcon(new ImageIcon(OCBCRewardTravelPanel.class.getResource("/Redeem/img/Play1.png")));
				...
				button_2.setIcon(new ImageIcon(OCBCRewardTravelPanel.class.getResource("/Redeem/img/Service1.png")));
				...
				btnNewButton_2.setIcon(new ImageIcon(OCBCRewardTravelPanel.class.getResource("/Redeem/img/Shop1.png")));
				...
				btnNewButton_4.setIcon(new ImageIcon(OCBCRewardTravelPanel.class.getResource("/Reward/img/KONSORTIUM EXPRESS AND TOURS.jpg")));
				btnNewButton_4.setBounds(10, 319, 175, 110);
				add(btnNewButton_4);
				
				JLabel lblNewLabel = new JLabel("KONSORTIUM EXPRESS AND TOURS");
				lblNewLabel.setFont(new Font("Arial", Font.PLAIN, 20));
				lblNewLabel.setBounds(10, 440, 176, 20);
				add(lblNewLabel);
				
				JLabel lblNewLabel_3 = new JLabel("3700 Points");
				...
				btnRedeemCart.setIcon(new ImageIcon(OCBCRewardTravelPanel.class.getResource("/Redeem/img/Cart.png")));
