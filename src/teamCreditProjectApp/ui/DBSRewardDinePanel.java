...
public class DBSRewardDinePanel extends MasterPanel {
	private static final long serialVersionUID = 1L;
	/**
	 * Create the panel.
	 */
	public DBSRewardDinePanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		setLayout(null);
		...
		internalFrame.setBounds(205, 187, 543, 396);
		add(internalFrame);
		...
		lblItemName.setText(alist.get(1).getItemName());
		...
		lblItemPoints.setText(blist.get(1).getItemPoints());
		...
		lblItemType.setText(clist.get(1).getItemType());
		...
		lblItemPic_1.setBounds(4, 31, 194, 104);
		...
		panel.add(btnRedeemcart);
			...
			button.setIcon(new ImageIcon(DBSRewardDinePanel.class.getResource("/Redeem/img/All1.png")));
			...
			btnNewButton_5.setIcon(new ImageIcon(DBSRewardDinePanel.class.getResource("/Reward/img/Ben & Jerry's S$10 Voucher.jpg")));
			...
			btnRedeemCart.setIcon(new ImageIcon(DBSRewardDinePanel.class.getResource("/Redeem/img/Cart.png")));
