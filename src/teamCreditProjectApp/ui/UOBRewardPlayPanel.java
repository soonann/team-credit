...
public class UOBRewardPlayPanel extends MasterPanel {
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public UOBRewardPlayPanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		...
		panel.add(btnRedeemcart);
				...
				btnNewButton.setIcon(new ImageIcon(UOBRewardPlayPanel.class.getResource("/Redeem/img/Search.png")));
				...
				button.setIcon(new ImageIcon(UOBRewardPlayPanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(UOBRewardPlayPanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_2.setIcon(new ImageIcon(UOBRewardPlayPanel.class.getResource("/Redeem/img/Service1.png")));
				...
				btnNewButton_2.setIcon(new ImageIcon(UOBRewardPlayPanel.class.getResource("/Redeem/img/Shop1.png")));
				...
				btnNewButton_3.setIcon(new ImageIcon(UOBRewardPlayPanel.class.getResource("/Redeem/img/Travel1.png")));
				...
				btnNewButton_8.setIcon(new ImageIcon(UOBRewardPlayPanel.class.getResource("/Reward/img/Saint Games $10 voucher.jpg")));
				btnNewButton_8.setBounds(10, 319, 152, 110);
				add(btnNewButton_8);
				
				JLabel lblNewLabel_9 = new JLabel("Saint Games $10 voucher");
				lblNewLabel_9.setFont(new Font("Arial", Font.PLAIN, 20));
				lblNewLabel_9.setBounds(10, 440, 170, 20);
				add(lblNewLabel_9);
				
				JLabel lblNewLabel_10 = new JLabel("1000 Points");
				lblNewLabel_10.setForeground(Color.RED);
				lblNewLabel_10.setBounds(10, 460, 102, 20);
				add(lblNewLabel_10);
				...
				btnRedeemCart.setIcon(new ImageIcon(UOBRewardPlayPanel.class.getResource("/Redeem/img/Cart.png")));
