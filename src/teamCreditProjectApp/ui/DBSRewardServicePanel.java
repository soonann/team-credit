...
public class DBSRewardServicePanel extends MasterPanel {
	 ...
	 * Create the panel.
	 */
	public DBSRewardServicePanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		setLayout(null);
		...
		lblItemName.setBounds(200, 63, 312, 36);
		panel.add(lblItemName);
		
		ArrayList<RewardsCart> alist = RewardsCartDA.retrieveAllRewardsCart();
		lblItemName.setText(alist.get(4).getItemName());
		...
		textItemDescription.setText("Voucher will expire 3 months from date\r\nof redemption or date of issue.\r\n");
		
		
		ArrayList<RewardsCart> elist_3 = RewardsCartDA.retrieveAllRewardsCart();
		//lblItemDescription.setText(elist_3.get(4).getItemPic());
		JLabel lblItemPic_3 = new JLabel("");
		lblItemPic_3.setIcon(new ImageIcon(OCBCRewardMainPanel.class.getResource("/Reward/img/" + elist_3.get(4).getItemPic())));
		...
		panel.add(btnRedeemcart);
				...
				btnNewButton.setIcon(new ImageIcon(DBSRewardServicePanel.class.getResource("/Redeem/img/Search.png")));
				...
				button.setIcon(new ImageIcon(DBSRewardServicePanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(DBSRewardServicePanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_1.setIcon(new ImageIcon(DBSRewardServicePanel.class.getResource("/Redeem/img/Play1.png")));
				...
				btnNewButton_2.setIcon(new ImageIcon(DBSRewardServicePanel.class.getResource("/Redeem/img/Shop1.png")));
				...
				btnNewButton_3.setIcon(new ImageIcon(DBSRewardServicePanel.class.getResource("/Redeem/img/Travel1.png")));
				...
				button_15.setIcon(new ImageIcon(DBSRewardServicePanel.class.getResource("/Reward/img/Esso Synergy S$40 Fuel Voucher.jpg")));
				button_15.setBounds(10, 319, 175, 110);
				add(button_15);
				
				JLabel lblEssoSynergyS = new JLabel("Esso Synergy S$40 Fuel Voucher");
				lblEssoSynergyS.setFont(new Font("Arial", Font.PLAIN, 20));
				lblEssoSynergyS.setBounds(10, 440, 175, 20);
				add(lblEssoSynergyS);
				...
				btnRedeemCart.setIcon(new ImageIcon(DBSRewardServicePanel.class.getResource("/Redeem/img/Cart.png")));
