...
public class DBSRewardShopPanel extends MasterPanel {
	 ...
	 * Create the panel.
	 */
	public DBSRewardShopPanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		setLayout(null);
		...
		lblItemName.setText(alist.get(3).getItemName());
		...
		lblItemPoints.setText(blist.get(3).getItemPoints());
		...
		lblItemType.setText(clist.get(3).getItemType());
		...
		panel.add(btnRedeemcart);
				...
				btnNewButton.setIcon(new ImageIcon(DBSRewardShopPanel.class.getResource("/Redeem/img/Search.png")));
				...
				button.setIcon(new ImageIcon(DBSRewardShopPanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(DBSRewardShopPanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_1.setIcon(new ImageIcon(DBSRewardShopPanel.class.getResource("/Redeem/img/Play1.png")));
				...
				button_2.setIcon(new ImageIcon(DBSRewardShopPanel.class.getResource("/Redeem/img/Service1.png")));
				...
				btnNewButton_3.setIcon(new ImageIcon(DBSRewardShopPanel.class.getResource("/Redeem/img/Travel1.png")));
				...
				button_9.setIcon(new ImageIcon(DBSRewardShopPanel.class.getResource("/Reward/img/Charles & Keith S$30 Voucher.jpg")));
				...
				btnRedeemCart.setIcon(new ImageIcon(DBSRewardShopPanel.class.getResource("/Redeem/img/Cart.png")));
