...
public class UOBRewardTravelPanel extends MasterPanel {
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public UOBRewardTravelPanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		...
		lblItemName.setText(alist.get(13).getItemName());
		...
		lblItemPoints.setText(blist.get(13).getItemPoints());
		...
		lblItemType.setText(clist.get(13).getItemType());
		...
		textItemDescription.setText("A S$25 administrative fee will be \r\nimposed for each conversion.\r\nThis fee will be waived for UOB VISA \r\nInfinite.");
		...
		panel.add(btnRedeemcart);
				...
				btnNewButton.setIcon(new ImageIcon(UOBRewardTravelPanel.class.getResource("/Redeem/img/Search.png")));
				...
				button.setIcon(new ImageIcon(UOBRewardTravelPanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(UOBRewardTravelPanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_1.setIcon(new ImageIcon(UOBRewardTravelPanel.class.getResource("/Redeem/img/Play1.png")));
				...
				button_2.setIcon(new ImageIcon(UOBRewardTravelPanel.class.getResource("/Redeem/img/Service1.png")));
				...
				btnNewButton_2.setIcon(new ImageIcon(UOBRewardTravelPanel.class.getResource("/Redeem/img/Shop1.png")));
				...
				btnNewButton_4.setIcon(new ImageIcon(UOBRewardTravelPanel.class.getResource("/Reward/img/10,000 Asia Miles.jpg")));
				btnNewButton_4.setBounds(10, 319, 175, 110);
				add(btnNewButton_4);
				
				JLabel lblNewLabel = new JLabel("10000 Asia Miles");
				lblNewLabel.setFont(new Font("Arial", Font.PLAIN, 20));
				lblNewLabel.setBounds(10, 440, 176, 20);
				add(lblNewLabel);
				
				JLabel lblNewLabel_3 = new JLabel("5000 Points");
				lblNewLabel_3.setForeground(Color.RED);
				lblNewLabel_3.setBounds(10, 460, 102, 20);
				add(lblNewLabel_3);
				...
				btnRedeemCart.setIcon(new ImageIcon(UOBRewardTravelPanel.class.getResource("/Redeem/img/Cart.png")));
