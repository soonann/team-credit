...
public class OCBCRewardDinePanel extends MasterPanel {
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public OCBCRewardDinePanel(JFrame mf,Login l1, String cardNumber) {
		super(mf,l1);
		setLayout(null);
		...
		lblItemName.setText(alist.get(6).getItemName());
		...
		lblItemPoints.setText(blist.get(6).getItemPoints());
		...
		lblItemType.setText(clist.get(6).getItemType());
		...
		textItemDescription.setText(dlist.get(6).getItemDescription());
		...
		panel.add(btnRedeemcart);
			...
			btnNewButton.setIcon(new ImageIcon(OCBCRewardDinePanel.class.getResource("/Redeem/img/Search.png")));
			...
			button.setIcon(new ImageIcon(OCBCRewardDinePanel.class.getResource("/Redeem/img/All1.png")));
			...
			btnNewButton_5.setIcon(new ImageIcon(OCBCRewardDinePanel.class.getResource("/Reward/img/Swensen's S$10 Voucher.jpg")));
			...
			btnRedeemCart.setIcon(new ImageIcon(OCBCRewardDinePanel.class.getResource("/Redeem/img/Cart.png")));
