...
public class DBSRewardTravelPanel extends MasterPanel {
	 ...
	 * Create the panel.
	 */
	public DBSRewardTravelPanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		setLayout(null);
		...
		panel.add(btnRedeemcart);
				...
				btnNewButton.setIcon(new ImageIcon(DBSRewardTravelPanel.class.getResource("/Redeem/img/Search.png")));
				...
				button.setIcon(new ImageIcon(DBSRewardTravelPanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(DBSRewardTravelPanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_1.setIcon(new ImageIcon(DBSRewardTravelPanel.class.getResource("/Redeem/img/Play1.png")));
				...
				button_2.setIcon(new ImageIcon(DBSRewardTravelPanel.class.getResource("/Redeem/img/Service1.png")));
				...
				btnNewButton_2.setIcon(new ImageIcon(DBSRewardTravelPanel.class.getResource("/Redeem/img/Shop1.png")));
				...
				btnNewButton_4.setIcon(new ImageIcon(DBSRewardTravelPanel.class.getResource("/Reward/img/1,500 BIG Points.png")));
				...
				lblNewLabel_3.setBounds(10, 460, 80, 20);
				add(lblNewLabel_3);
				...
				btnRedeemCart.setIcon(new ImageIcon(DBSRewardTravelPanel.class.getResource("/Redeem/img/Cart.png")));
