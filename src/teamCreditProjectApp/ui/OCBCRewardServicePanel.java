...
public class OCBCRewardServicePanel extends MasterPanel {
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public OCBCRewardServicePanel(JFrame mf,Login l1, String cardNumber) {
		super(mf,l1);
		...
		lblItemType.setBounds(15, 138, 106, 20);
		...
		textItemDescription.setText(dlist.get(5).getItemDescription());
		...
		panel.add(btnRedeemcart);
				...
				button.setIcon(new ImageIcon(OCBCRewardServicePanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(OCBCRewardServicePanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_1.setIcon(new ImageIcon(OCBCRewardServicePanel.class.getResource("/Redeem/img/Play1.png")));
				...
				btnNewButton_2.setIcon(new ImageIcon(OCBCRewardServicePanel.class.getResource("/Redeem/img/Shop1.png")));
				...
				btnNewButton_3.setIcon(new ImageIcon(OCBCRewardServicePanel.class.getResource("/Redeem/img/Travel1.png")));
				...
				button_15.setIcon(new ImageIcon(OCBCRewardServicePanel.class.getResource("/Reward/img/caltext.jpg")));
				button_15.setBounds(10, 319, 161, 110);
				add(button_15);
				
				JLabel lblEssoSynergyS = new JLabel("CALTEX $10 Voucher");
				lblEssoSynergyS.setFont(new Font("Arial", Font.PLAIN, 20));
				lblEssoSynergyS.setBounds(10, 440, 133, 20);
				add(lblEssoSynergyS);
				
				JLabel lblPoints_14 = new JLabel("3500 Points");
				...
				btnRedeemCart.setIcon(new ImageIcon(OCBCRewardServicePanel.class.getResource("/Redeem/img/Cart.png")));
