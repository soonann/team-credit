...
public class UOBRewardDinePanel extends MasterPanel {
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public UOBRewardDinePanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		...
		lblItemName.setBounds(200, 63, 327, 36);
		panel.add(lblItemName);
		
		ArrayList<RewardsCart> alist = RewardsCartDA.retrieveAllRewardsCart();
		lblItemName.setText(alist.get(10).getItemName());
		...
		lblItemPoints.setText(blist.get(10).getItemPoints());
		...
		lblItemType.setText(clist.get(10).getItemType());
		...
		textItemDescription.setText(dlist.get(10).getItemDescription());
		...
		panel.add(btnRedeemcart);
			...
			btnNewButton.setIcon(new ImageIcon(UOBRewardDinePanel.class.getResource("/Redeem/img/Search.png")));
			...
			button.setIcon(new ImageIcon(UOBRewardDinePanel.class.getResource("/Redeem/img/All1.png")));
			...
			btnNewButton_5.setIcon(new ImageIcon(UOBRewardDinePanel.class.getResource("/Reward/img/Manhattan Fish Market S$20 Voucher.jpg")));
			btnNewButton_5.setBounds(10, 319, 175, 110);
			add(btnNewButton_5);
			
			JLabel lblNewLabel_4 = new JLabel("Manhattan Fish Market $20 Voucher");
			lblNewLabel_4.setFont(new Font("Arial", Font.PLAIN, 20));
			lblNewLabel_4.setBounds(10, 440, 176, 20);
			add(lblNewLabel_4);
			
			JLabel lblNewLabel_5 = new JLabel("1300 Points");
			lblNewLabel_5.setForeground(Color.RED);
			lblNewLabel_5.setBounds(10, 460, 99, 20);
			add(lblNewLabel_5);
			...
			btnRedeemCart.setIcon(new ImageIcon(UOBRewardDinePanel.class.getResource("/Redeem/img/Cart.png")));
