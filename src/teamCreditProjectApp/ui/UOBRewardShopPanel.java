...
public class UOBRewardShopPanel extends MasterPanel {
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public UOBRewardShopPanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		...
		lblItemName.setText(alist.get(12).getItemName());
		...
		lblItemPoints.setText(blist.get(12).getItemPoints());
		...
		lblItemType.setText(clist.get(12).getItemType());
		...
		textItemDescription.setText("Redeemable at Takashimaya Department \r\nStore Cashier Counters. \r\nNot exchangeable for cash.");
		...
		panel.add(btnRedeemcart);
				...
				btnNewButton.setIcon(new ImageIcon(UOBRewardShopPanel.class.getResource("/Redeem/img/Search.png")));
				...
				button.setIcon(new ImageIcon(UOBRewardShopPanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(UOBRewardShopPanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_1.setIcon(new ImageIcon(UOBRewardShopPanel.class.getResource("/Redeem/img/Play1.png")));
				...
				button_2.setIcon(new ImageIcon(UOBRewardShopPanel.class.getResource("/Redeem/img/Service1.png")));
				...
				btnNewButton_3.setIcon(new ImageIcon(UOBRewardShopPanel.class.getResource("/Redeem/img/Travel1.png")));
				...
				button_9.setIcon(new ImageIcon(UOBRewardShopPanel.class.getResource("/Reward/img/Takashimaya Department Store S$50 Voucher.jpg")));
				...
				btnRedeemCart.setIcon(new ImageIcon(UOBRewardShopPanel.class.getResource("/Redeem/img/Cart.png")));
