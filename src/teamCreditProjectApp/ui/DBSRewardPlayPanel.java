...
public class DBSRewardPlayPanel extends MasterPanel {
	 ...
	 * Create the panel.
	 */
	public DBSRewardPlayPanel(JFrame mf,Login l1,String cardNumber) {
		super(mf,l1);
		setLayout(null);
		...
		lblItemName.setText(alist.get(2).getItemName());
		...
		lblItemPoints.setText(blist.get(2).getItemPoints());
		...
		lblItemType.setText(clist.get(2).getItemType());
		...
		panel.add(btnRedeemcart);
				...
				btnNewButton.setIcon(new ImageIcon(DBSRewardPlayPanel.class.getResource("/Redeem/img/Search.png")));
				...
				button.setIcon(new ImageIcon(DBSRewardPlayPanel.class.getResource("/Redeem/img/All1.png")));
				...
				btnNewButton_1.setIcon(new ImageIcon(DBSRewardPlayPanel.class.getResource("/Redeem/img/Dine1.png")));
				...
				button_2.setIcon(new ImageIcon(DBSRewardPlayPanel.class.getResource("/Redeem/img/Service1.png")));
				...
				btnNewButton_2.setIcon(new ImageIcon(DBSRewardPlayPanel.class.getResource("/Redeem/img/Shop1.png")));
				...
				btnNewButton_3.setIcon(new ImageIcon(DBSRewardPlayPanel.class.getResource("/Redeem/img/Travel1.png")));
				...
				btnNewButton_8.setIcon(new ImageIcon(DBSRewardPlayPanel.class.getResource("/Reward/img/Golden Village 1 Movie Ticket (Anyday).jpg")));
				btnNewButton_8.setBounds(10, 319, 175, 110);
				add(btnNewButton_8);
				
				JLabel lblNewLabel_9 = new JLabel("Golden Village 1 Movie Ticket (Anyday)");
				lblNewLabel_9.setFont(new Font("Arial", Font.PLAIN, 20));
				lblNewLabel_9.setBounds(10, 440, 170, 20);
				add(lblNewLabel_9);
				
				JLabel lblNewLabel_10 = new JLabel("750 Points");
				lblNewLabel_10.setForeground(Color.RED);
				lblNewLabel_10.setBounds(10, 460, 83, 20);
				add(lblNewLabel_10);
				...
				btnRedeemCart.setIcon(new ImageIcon(DBSRewardPlayPanel.class.getResource("/Redeem/img/Cart.png")));
